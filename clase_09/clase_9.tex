...
\begin{frame}{Creación de ítems de opción múltiple}
	\justifying
	Ahora, en grupos, deberá \textbf{crear tres preguntas de opción múltiple para el indicador de evaluación IE1.1}, si no se puede ajustará el IE1.1 para que admita preguntas de selección múltiple de su tabla de especificaciones.
\end{frame}
