...
\begin{frame}{Prueba 3. Sumativa}
	Usted deberá entregar una pauta de corrección la cual deberá contener:
	\begin{enumerate}[<+->]
		\item Un título coherente.
		\item Puntuación total del instrumento.
		\item Objetivo de Aprendizaje del instrumento
		\item Indicador de evaluación de la pregunta cerrada.
		\item Instrucciones para la pregunta cerrada, incluyendo el puntaje y mecanismos.
		\item 1 ítem de selección múltiple de 4 alternativas y con la clave marcada.
		\item Instrucción de la pregunta abierta, incluyendo el puntaje.
		\item Indicador de evaluación de la pregunta abierta.
		\item Pregunta abierta
		\item Respuesta máxima
		\item Rúbrica analítica con 4 niveles de desempeño y 4 dimensiones.
	\end{enumerate}
\end{frame}
