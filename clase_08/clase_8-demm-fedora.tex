...
\pgfdeclareimage[width=16.2cm]{mybackground}{../template/background_title_page}
...
\pgfdeclareimage[width=16.2cm]{sectionbackground}{../template/background_section_page}
...
\setbeamertemplate{background}{
	\includegraphics[width=16.2cm]{../template/background_slide_page}
}

\setbeamertemplate{frametitle}{
	%\fbox{
		\begin{minipage}[c][14mm][b]{\textwidth}
